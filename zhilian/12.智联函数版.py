...
def get_url_content():
    ...
    url = 'https://fe-api.zhaopin.com/c/i/sou?pageSize=60&cityId={}&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw={}&kt=3&lastUrlQuery=%7B'.format(
        city, kw)
    print(url)
